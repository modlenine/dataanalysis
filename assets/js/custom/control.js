...
let sessionEcode = $("#checkSessionEcode").val();
  ...
  if ($("#checkDeptCode").val() == "1007") {
    ...
    if ($("#checkPosi").val() == 15) {
      ...
      // if(sessionEcode == "M0089" || sessionEcode == "M1832" || sessionEcode == "M0126" || sessionEcode == "M0085"){
      //   //สิทธิ์พี่ทีป M0126 = pansak , M0040 = sompong nakarangsu
      //   $("#m_list").css("display", "");
      // }

      // รายชื่อพนักงานสิทธิ์พิเศษ
      const specialUsers = ["M0089", "M1832", "M0126", "M0085" , "M1551" , "M0506" , "M2067" , "M1413"];
      //สิทธิ์พี่ทีป M0126 = pansak , 
      // M0040 = sompong nakarangsu , 
      // M1551 = anon_k , 
      // M0506 = jakarin , 
      // M0085 = tawan , 
      // M2067 = yaowaman_b , 
      ...
      // ใช้ค้นหา
      if (specialUsers.includes(sessionEcode)) {
        $("#m_list").show();   // เท่ากับ css('display','')
      } else {
        $("#m_list").hide();
      }
  ...
  if ($("#checkpage").val() == "viewmaindata.html") {
    ...
    $(document).on("click", ".texttab", function () {
      ...
      if ($("#checkStartPage2").val() == "Stop") {
        //Speacial User สามารถแก้ไขรายการได้หลังจากที่ Stop เอกสารไปแล้ว M0089=prateep
        if (sessionEcode == "M0089" || sessionEcode == "M1832" || sessionEcode == "M0085") {
              ...
              let userUse = res.userUse;
                swal({
                    ...
                    if(result.value == true){
                      ...
                      // if(
                      //   $('#checkSessionEcode').val() == "M1809" || 
                      //   $('#checkSessionEcode').val() == "M1413" || 
                      //   $('#checkSessionEcode').val() == "M0089" || 
                      //   $('#checkSessionEcode').val() == "M2117" || 
                      //   $('#checkSessionEcode').val() == "M2067" || 
                      //   $('#checkSessionEcode').val() == "M1832" || 
                      //   $('#checkSessionEcode').val() == "M0085"
                      // ){
                      ...
                      const CAN_EDIT_DELETE = ["M1809","M1413","M0089","M2117","M2067","M1832","M0085","M0126","M1551","M0506"];

                      $('#btnSelectTemplate_edit, #btnSelectTemplate_delete')
                        .toggle(CAN_EDIT_DELETE.includes(ecode));
